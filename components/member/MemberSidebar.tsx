...
const nav = [
  ...
  { label: "Mon Diagnostic",   href: "/espace-membre/diagnostic",   icon: <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg> },
        ...
        {nav.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href}
              className="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-medium transition-colors relative"
              style={{
