        ...
        >
          ...
          <div className="relative">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                href="/diagnostic"
                className="group inline-flex items-center gap-2 rounded-xl px-8 py-4 text-sm font-semibold text-white transition-transform hover:scale-[1.03] active:scale-[0.98]"
