    ...
    <div className="max-w-xl space-y-6">
      ...
      <div className="rounded-2xl p-10 text-center"
        ...
        <button onClick={() => router.push("/espace-membre/progression")}
          className="mt-6 rounded-xl px-5 py-2.5 text-sm font-semibold text-white transition-transform hover:scale-[1.02]"
        ...
        {phase === "result" && (
          <motion.div key="result"
            ...
            <div className="rounded-2xl p-8 text-center space-y-5"
              ...
              <span className="inline-block rounded-full px-5 py-1.5 text-sm font-bold"
                style={{ background: badge.bg, color: badge.color, border: `1px solid ${badge.color}40` }}>
                <svg className="h-4 w-4 inline-block mr-1.5 -mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" /></svg>{badge.label}
              </span>
