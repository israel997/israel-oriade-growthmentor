...
type Outil = { slug: string; name: string; category: string; rating: number; price: string; logoGradient: string };

export default function AdminOutilsPage() {
  const [items, setItems] = useState<Outil[]>([]);
  ...
  const handleDelete = async () => {
    ...
    await fetch(`/api/outils/${deleteTarget}`, { method: "DELETE" });
